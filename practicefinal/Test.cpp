...
//All four aces, and tests for proper cleanup via valgrind
void Tests::AllAces()
{
    Deck aces;
    aces.Push(new DeckCard("Ace", "Clubs"));
    aces.Push(new DeckCard("Ace", "Spades"));
    aces.Push(new DeckCard("Ace", "Hearts"));
    aces.Push(new DeckCard("Ace", "Diamonds"));
    std::cout<<"Run against valgrind"<<std::endl;
}
